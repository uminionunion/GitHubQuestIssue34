        ...
        <Button variant="ghost" size="icon" className="absolute top-4 left-4 z-50" onClick={onClose}>
         ...
         <div className="flex border-t md:h-auto h-12">
           <div id="MainUhubFeatureV001ForMyProfileSettingsBottomLeftSection" className="w-[20%] p-1 md:p-2 border-r flex items-center">
             <Button variant="ghost" size="icon" className="h-6 w-6 md:h-5 md:w-5 p-1" onClick={() => handleSocialNavLeft('left')}><ChevronLeft className="h-3 w-3 md:h-3 md:w-3" /></Button>
             ...
             <Button variant="ghost" size="icon" className="h-6 w-6 md:h-5 md:w-5 p-1" onClick={() => handleSocialNavLeft('right')}><ChevronRight className="h-3 w-3 md:h-3 md:w-3" /></Button>
           </div>
           ...
           <div id="MainUhubFeatureV001ForMyProfileSettingsBottomRightSection" className="w-[20%] p-1 md:p-2 border-l flex items-center">
              <Button variant="ghost" size="icon" className="h-6 w-6 md:h-5 md:w-5 p-1" onClick={() => handleSocialNavRight('left')}><ChevronLeft className="h-3 w-3 md:h-3 md:w-3" /></Button>
             <div className="flex-grow hidden md:grid grid-cols-3 gap-0.5 md:gap-2 place-items-center">
             ...
             <div className="flex-grow md:hidden flex justify-center items-center">
              ...
              <Button variant="ghost" size="icon" className="h-6 w-6 md:h-5 md:w-5 p-1" onClick={() => handleSocialNavRight('right')}><ChevronRight className="h-3 w-3 md:h-3 md:w-3" /></Button>
            </div>
          </div>
       </div>
